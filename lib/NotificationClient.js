...
class NotificationClient {
  ...
  /**
   * Sends organisation request approved email to all other approvers
   */

  async sendOrganisationRequestOutcomeToApprovers(
    organisationId,
    approverUserId,
    email,
    name,
  ...
  /**
   * Sends Service request approved email to all other approvers
   */

  async sendServiceRequestApprovedToApprovers(
    email,
    firstName,
    lastName,
    orgName,
  ...
  /**
   * Sends Service request rejected email to all other approvers
   */

  async sendServiceRequestRejectedToApprovers(
    email,
    firstName,
    lastName,
    orgName,
  ...
  /**
   * Sends Sub-service request rejected email to all other approvers
   */

  async sendSubServiceRequestRejectedToApprovers(
    email,
    firstName,
    lastName,
    orgName,
  ...
  /**
   * Sends Sub-service request approved email to all other approvers
   */

  async sendSubServiceRequestApprovedToApprovers(
    email,
    firstName,
    lastName,
    orgName,
    ...
    await send(
      "sub_service_request_approved_to_approvers",
      {
        email,
        firstName,
        lastName,
